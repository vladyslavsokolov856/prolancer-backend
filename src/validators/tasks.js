...
const taskValidators = [
  ...
  body('payment_term')
    ...
    .withMessage('payment_term must be either "Current month" or "Ongoing week", "Other", "Task end".'),
  ...
  body('payment_type')
    ...
    .withMessage('payment_type must be either "Per day" or "Per hour", "Project price".'),
